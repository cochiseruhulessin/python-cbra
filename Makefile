...
reboot:
	@rm -rf MANIFEST.in setup.py $(PYTHON_PKG_NAME)
	@make bootstrap PYTHON_PKG_NAME=$(python.reboot)
	@rm -rf $(PYTHON_PKG_NAME)/app/tests
	@rm -rf $(PYTHON_PKG_NAME)/runtime/tests
